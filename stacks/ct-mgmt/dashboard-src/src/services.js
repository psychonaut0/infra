...
export const sections = [
  {
    name: 'Quick Access',
    services: [
      { name: 'Home Assistant', desc: 'Automation', href: 'http://homeassistant.lan', ping: 'http://192.168.3.10:8123', icon: `${I}/home-assistant.svg` },
      { name: 'Jellyfin', desc: 'Media server', href: 'http://jellyfin.lan', ping: 'http://192.168.3.8:8096', icon: `${I}/jellyfin.svg` },
      { name: 'Immich', desc: 'Photos', href: 'http://immich.lan', ping: 'http://192.168.3.9:2283', icon: `${I}/immich.svg` },
    ],
  },
  {
    name: 'Often',
    services: [
      ...
      { name: 'Frigate', desc: 'NVR', href: 'http://nvr.lan', ping: 'http://192.168.3.7:5000', icon: `${I}/frigate.svg` },
    ],
  },
  {
    name: 'Infrastructure',
